  ...
  render() {
    ...
    return (
      <div className="app-container">
        ...
        {/* INITIALLY ALL PROJECTS SHOWN. But here projects needs to be displayed according to category.
        When a tab is clicked, get category of that tab item and filter projects of it and displays  
